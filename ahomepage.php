                    ...
                    <div class="hardware-form">
                        ...
                        <div class="sp4"></div>
                            <div class="d-flex flex-column align-items-center">
								<button type="submit" name="signup" id="code" class="btn rounded-pill btn-primary w-50">SIGN UP</button>
			...
			<div id="myModal2" class="modal">
                <div class="modal-content">
                    <div class="hardware-form">
                        ...
                        <div class="sp4"></div>
                            <div class="d-flex flex-column align-items-center">
								<button type="submit" name="create" id="code" class="btn rounded-pill btn-primary w-50">SIGN UP</button>
